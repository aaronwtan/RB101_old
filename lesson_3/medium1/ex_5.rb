...
# Ben coded up this implementation but complained that
# as soon as he ran it, he got an error. Something
...
# limit needs to either be initialized within fib for it to have access
# or limit needs to be passed as an argument into fib
