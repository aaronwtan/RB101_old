...
# or overridden by the String class? That is, the list should exclude all members that are only defined 
# in Object, BasicObject, and Kernel.
puts s.public_methods(false).inspect # all parameter set to false so that only methods defined in the String class are listed