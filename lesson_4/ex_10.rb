...
munsters.values.each do |demos|
  age = demos["age"]

  if age.between?(0, 17)
    demos["age_group"] = "kid"
  elsif age.between?(18, 64)
    demos["age_group"] = "adult"
  elsif age >= 65
    demos["age_group"] = "senior"
  end
end

p munsters

# alternatively using ranges and case statements
munsters.each do |name, demos|
  case demos["age"]
  when 0..17  then demos["age_group"] = "kid"
  when 18..64 then demos["age_group"] = "adult"
  else             demos["age_group"] = "senior"
  end
end
